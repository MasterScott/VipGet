...
class Session
{
    ...
    function Session($pdoDb, $gc_maxlifetime = '', $gc_probability = '', $gc_divisor = '')
    {
        global $config;
        ...
        $sql = 'UPDATE '. $this->prefix .'sessions
				SET '.$moreUpdate.'
    ...
    function write($session_id, $session_data)
    {
        ...
        else
        {
            ...
            $sql = 'INSERT INTO '. $this->prefix .'sessions(`s_id`, `s_data`, `s_agent`, `s_ipaddress`, `s_hash`, `s_userid`, `s_dateexpired`, `s_datecreated`)
					VALUES(?, ?, ?, ?, ?, ?, ?, ?)';
    ...
    function destroy($session_id)
    {
        ...
        $sql = 'DELETE FROM '. $this->prefix .'sessions
				WHERE s_id = ?
				';
